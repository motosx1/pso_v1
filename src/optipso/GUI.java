...
public class GUI extends JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        FunctionComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"Parabola", "Okregi 1", "Okregi 2", "Jajka 1", "Jajka 2"}));
    ...
    /* BLOKOWANIE SPINNEROW */
    private void setDisabledSpinner() {
        StepsSpinner.setEnabled(false);
        ParticlesSpinner.setEnabled(false);
